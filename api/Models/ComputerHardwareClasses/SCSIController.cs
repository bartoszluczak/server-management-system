namespace ServerManagementSystem.Models.ComputerHardwareClasses
{
    public class SCSIController
    {
        ...
        public string ControllerTimeouts {get; set;}
